...
//	private Matcher Ans;
	...
	public GameObject ColliderBlock5;
	...
	void Start () {
		...
		GameObject.FindObjectOfType <Matcher>().HardAnswers();
		...
		Instantiate (TopHole,new Vector2(xRightEdge - 1.2f,yTopEdge - 1.2f*yHeightAdj), Quaternion.identity);
		Instantiate (TopMidHole,new Vector2(xRightEdge - 1.2f,yTopEdge - 3.6f*yHeightAdj), Quaternion.identity);
		Instantiate (MidHole,new Vector2(xRightEdge - 1.2f,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Instantiate (BotMidHole,new Vector2(xRightEdge - 1.2f,yTopEdge - 8.4f*yHeightAdj), Quaternion.identity);
		Instantiate (BotHole,new Vector2(xRightEdge - 1.2f,yTopEdge - 10.8f*yHeightAdj), Quaternion.identity);
		...
		if (indexkey !=2) {
			...
			Instantiate (Colors[0],new Vector3(xRightEdge - 1.2f,yTopEdge - 1.2f*yHeightAdj,0.5f), Quaternion.identity);
			Instantiate (Colors[1],new Vector3(xRightEdge - 1.2f,yTopEdge - 3.6f*yHeightAdj,0.5f), Quaternion.identity);
			Instantiate (Colors[2],new Vector3(xRightEdge - 1.2f,yTopEdge - 6f*yHeightAdj,0.5f), Quaternion.identity);
			Instantiate (Colors[3],new Vector3(xRightEdge - 1.2f,yTopEdge - 8.4f*yHeightAdj,0.5f), Quaternion.identity);
			Instantiate (Colors[4],new Vector3(xRightEdge - 1.2f,yTopEdge - 10.8f*yHeightAdj,0.5f), Quaternion.identity);
		}
		
		Instantiate (ColliderBlock1,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (10.8f-(2.4f*Answers.IndexOf (1))))*yHeightAdj), Quaternion.identity);
		Instantiate (ColliderBlock2,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (10.8f-(2.4f*Answers.IndexOf (2))))*yHeightAdj), Quaternion.identity);
		Instantiate (ColliderBlock3,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (10.8f-(2.4f*Answers.IndexOf (3))))*yHeightAdj), Quaternion.identity);
		Instantiate (ColliderBlock4,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (10.8f-(2.4f*Answers.IndexOf (4))))*yHeightAdj), Quaternion.identity);
		Instantiate (ColliderBlock5,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (10.8f-(2.4f*Answers.IndexOf (5))))*yHeightAdj), Quaternion.identity);
		...
		Instantiate (ScriptPegs,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - 0.8f*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (ScriptHoles,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - 0.8f*yHeightAdj,-2.5f), Quaternion.identity);
		
		Instantiate (Arrow,new Vector3(xRightEdge - 9f*xWidthAdj,yTopEdge - 2.4f*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (Arrow,new Vector3(xRightEdge - 9f*xWidthAdj,yTopEdge - 4.5f*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (Arrow,new Vector3(xRightEdge - 9f*xWidthAdj,yTopEdge - 6.6f*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (Arrow,new Vector3(xRightEdge - 9f*xWidthAdj,yTopEdge - 8.7f*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (Arrow,new Vector3(xRightEdge - 9f*xWidthAdj,yTopEdge - 10.8f*yHeightAdj,-2.5f), Quaternion.identity);
		...
		Instantiate (TopDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (1.2f+2.1f*aa))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (TopMidDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (1.2f+2.1f*bb))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (MidDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (1.2f+2.1f*cc))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (BotMidDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (1.2f+2.1f*dd))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (BotDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (1.2f+2.1f*ee))*yHeightAdj,-2.5f), Quaternion.identity);
		
		List<float> Pegspots = new List<float> {aa,bb,cc,dd,ee};
		Instantiate (TopDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[0]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (TopMidDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[1]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (MidDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[2]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (BotMidDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[3]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (BotDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[4]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
	
		if (SceneManager.GetActiveScene().name.Contains("Color")) {
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[0]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[1]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[2]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[3]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f - (1.2f+(2.1f*Pegspots[Answers[4]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
        }
    ...
    void PegPlacement() {
		...
		List<int> Order = new List<int>{x1,x2,x3,y1,y2,y3,z1,z2,z3,w1,w2,w3,v1,v2,v3};
		...
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 10.5f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 8.625f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 6.75f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 4.875f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 3f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 10.5f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 8.625f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 6.75f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 4.875f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 3f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
    }
