...
//	private Matcher Ans;
	...
	void Start () {
		...
		if (indexkey !=2) {
			...
			Instantiate (Colors[0],new Vector3(xRightEdge - 1.2f,yTopEdge - 3f*yHeightAdj,0.5f), Quaternion.identity);
			Instantiate (Colors[1],new Vector3(xRightEdge - 1.2f,yTopEdge - 6f*yHeightAdj,0.5f), Quaternion.identity);
			Instantiate (Colors[2],new Vector3(xRightEdge - 1.2f,yTopEdge - 9f*yHeightAdj,0.5f), Quaternion.identity);
		}
		
		Instantiate (ColliderBlock1,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (9-(3*Answers.IndexOf (1))))*yHeightAdj), Quaternion.identity);
		Instantiate (ColliderBlock2,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (9-(3*Answers.IndexOf (2))))*yHeightAdj), Quaternion.identity);
		Instantiate (ColliderBlock3,new Vector2(xRightEdge-0.2f,yTopEdge - (12f - (9-(3*Answers.IndexOf (3))))*yHeightAdj), Quaternion.identity);
		...
		Instantiate (ScriptPegs,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - 1.8f*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (ScriptHoles,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - 1.8f*yHeightAdj,-2.5f), Quaternion.identity);
		...
		Instantiate (TopDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (2.8f+2.7f*aa))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (MidDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (2.8f+2.7f*bb))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (BotDispPeg,new Vector3(xRightEdge - 9f*xWidthAdj - 2f,yTopEdge - (12f - (2.8f+2.7f*cc))*yHeightAdj,-2.5f), Quaternion.identity);

		List<float> Pegspots = new List<float> {aa,bb,cc};
		Instantiate (TopDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f -(2.8f+(2.7f*Pegspots[Answers[0]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (MidDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f -(2.8f+(2.7f*Pegspots[Answers[1]-1])))*yHeightAdj,-2.5f), Quaternion.identity);
		Instantiate (BotDispHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f -(2.8f+(2.7f*Pegspots[Answers[2]-1])))*yHeightAdj,-2.5f), Quaternion.identity);	
        
		if (SceneManager.GetActiveScene().name.Contains("Color")) {
            Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f -(2.8f+(2.7f*Pegspots[Answers[0]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f -(2.8f+(2.7f*Pegspots[Answers[1]-1])))*yHeightAdj,-3.5f), Quaternion.identity);
		    Instantiate (DispHoleHole,new Vector3(xRightEdge - 9f*xWidthAdj + 2f,yTopEdge - (12f -(2.8f+(2.7f*Pegspots[Answers[2]-1])))*yHeightAdj,-3.5f), Quaternion.identity);	 
        }
    ...
    void PegPlacement() {
		...
		List<int> Order = new List<int>{x1,x2,x3,y1,y2,y3,z1,z2,z3};
		
		int a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 9f*xWidthAdj,yTopEdge - 9f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		...
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 4.5f*xWidthAdj,yTopEdge - 9f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);

		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 9f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		...
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 4.5f*xWidthAdj,yTopEdge - 6f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);

		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 9f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
		Order.RemoveAt (a);
		...
		a = Random.Range (0,Order.Count);
		Instantiate (Pegs[Order[a]],new Vector2(xRightEdge - 4.5f*xWidthAdj,yTopEdge - 3f*yHeightAdj), Quaternion.identity);
    }
